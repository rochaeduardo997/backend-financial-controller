...
import { AdminCategoriesController } from '@categories/admins/controllers/admin-categories.controller';
  ...
  describe('Save', () => {
    ...
    describe('Fail', () => {
      it.each([
        ...
        'should fail on save a new category %s',
        async (_, field, expected) => {
          const toSend = {
            ...categoryMock1,
            ...field,
            id: undefined,
